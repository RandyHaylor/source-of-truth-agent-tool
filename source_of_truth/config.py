...
INTERACTION_TIME_AGENT_GUIDANCE: str = (
    ...
    "Title rule: short_neutral_title (1-50 chars) is the SUBJECT of the requirement, not the\n"
    "spec. Do NOT add detail/contrast/scope beyond the cited slice; reviewer will rewrite if\n"
    "you do (your title becomes amended_short_title).\n"
